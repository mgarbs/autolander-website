...
export const PAGES = [
  ...
  // ---------------------------------------------------------------- HUB: /guide/car-dealership-marketing/
  {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Answer in seconds, not hours', body: 'Marketplace buyers message five dealers at once and buy from the one who answers. Name an owner per shift and keep Messenger on their phone — AutoLander’s part is making sure the listing they are answering about carries the right price and specs. The [speed-to-lead playbook](/guide/car-sales-leads/) keeps the reply under a minute.' },
    ...
    cta: {
      ...
      sub: 'AutoLander posts your inventory to Facebook Marketplace, makes the photos showroom-grade, keeps every price in step with your feed and shows you which posts sold cars.',
    },
  ...
  // ------------------------------------------------- SPOKE: /guide/car-dealership-marketing-ideas/
  {
    ...
    cta: {
      ...
      sub: 'AutoLander lists the whole lot on Marketplace, upgrades every photo, keeps prices synced and pulls sold units — the top of this list, running by itself.',
    },
  },
  ...
  // ---------------------------------------------------------------- SPOKE: /guide/car-sales-leads/
  {
    ...
    cta: {
      ...
      sub: 'AutoLander posts every unit and keeps it accurate — direct buyer conversations no other store is also working.',
    },
  },
  ...
  // ------------------------------------------------- SPOKE: /guide/social-media-for-car-dealers/
  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          { title: 'Marketplace inbox — where deals start', body: 'Social attention converts in chat, and that inbox stays yours. AutoLander’s job is upstream: the car a Sunday-night message is about is still for sale and still priced correctly, so the reply turns into a Monday appointment.' },
      ...
      },
      {
        ...
        steps: [
          { title: 'Daily (automated)', body: 'Inventory posted and refreshed on Marketplace, prices resynced, sold units removed — the upkeep is software, the conversations are yours.' },
    ...
    cta: {
      ...
      sub: 'AutoLander keeps Marketplace complete, current and accurate — you keep the conversations human.',
    },
  },
  ...
  // ---------------------------------------------------------------- SPOKE: /guide/how-to-sell-more-cars/
  {
    ...
    sections: [
      ...
      },
      {
        ...
        cards: [
          ...
          { title: '4. Speed — first real answer wins', body: 'The store that responds in seconds gets the test drive. AutoLander makes sure that answer is right — synced price, real specs, sold units already gone — and the [speed-to-lead playbook](/guide/car-sales-leads/) does the rest.' },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Week 3 — Speed', body: 'Put the Marketplace inbox on your closers’ phones, name an owner per shift, and start measuring minutes-to-first-reply like you measure gross.' },
    ...
    faq: [
      ...
      ['Does AI really help sell more cars?',
        'AI moves two of the six levers directly: photos (the AI studio) and coverage (automated posting) — and accurate, always-synced listings help your team win the speed lever. What actually works and what is hype is covered in [AI for car dealerships](/guide/ai-for-car-dealerships/).'],
    ],
    cta: {
      heading: 'Four levers, one app, live this week',
      sub: 'Coverage, photos, synced prices and sold-unit truth — AutoLander runs them while your floor sells.',
    },
  },
  ...
  // ---------------------------------------------------------------- SPOKE: /guide/ai-for-car-dealerships/
  {
    ...
    sections: [
      ...
      },
      {
        ...
        a: [
          ...
          'AutoLander takes the other route: it stays out of the inbox entirely — no automated replies, and no '
          + 'message handling of any kind. It keeps every listing’s data accurate so the human who answers has '
          + 'the right facts — the trade-offs are laid out in the '
          + '[honest guide to AI chat for car dealers](/ai-chat-for-car-dealers/).',
        ],
      },
      {
        type: 'bullets',
    ...
    faq: [
      ['What is the best AI tool for a car dealership?',
        'The one that completes a job you are currently losing money on. For most independents that is AI photo enhancement and AI-written listings — both ship inside AutoLander, alongside automated posting and sold-unit removal. See the [Facebook AI tools guide](/facebook-ai-tools/) for the full breakdown.'],
