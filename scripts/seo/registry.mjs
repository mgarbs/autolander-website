...
export const NAV = {
  ...
  // Customer training library (2026-09-22). A STATIC mirror under public/training/ generated by
  // scripts/training/build-training-mirror.mjs (npm run training:build) - deliberately NOT a PAGES
